...
<div class="container">
  ...
  <form class="form-inline" method="GET">
    <div class="form-group">
      <input type="text" class="form-control" id="ver" name="ver" placeholder="输入推送消息说明">
    </div>
    <button type="submit" class="btn btn-default save">添加消息</button>
  </form>
  </div>
...
$(document).ready(function(){
    ...
    $(".save").click(function(){
        ...
        $.post("/message/create", {ver:ver}, function(data){
            if(data=="success"){
                reloadPage()
            }else{
                alert(data)
    ...
    $("#editBtn").click(function(){
        ...
        $.post("/message/update", pdata, function(data){
            if(data=="success"){
                reloadPage()
            }else{
                alert(data)
    ...
    $(".changestate").click(function(){
        ...
        $.post("/message/change_state", {id: id, state: state}, function(data){
            if(data=="success"){
                reloadPage()
            }else{
                alert(data)
